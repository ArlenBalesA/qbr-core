...
RegisterNetEvent('QBCore:Server:UseItem', function(item)
    print(string.format("%s triggered QBCore:Server:UseItem by ID %s with the following data. This event is deprecated due to exploitation, and will be removed soon. Check qbr-inventory for the right use on this event.", GetInvokingResource(), source))
    QBCore.Debug(item)
end)
